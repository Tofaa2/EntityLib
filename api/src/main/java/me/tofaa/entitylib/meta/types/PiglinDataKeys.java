...
public class PiglinDataKeys extends MonsterDataKeys {
     ...
     * Supported versions: 1.16+
     */
    public static final EntityDataKey<Boolean> BABY = EntityDataKey.<Boolean>builder(PiglinDataKeys.class)
     ...
     * Supported versions: 1.16
     */
    public static final EntityDataKey<Boolean> IMMUNE_TO_ZOMBIFICATION = EntityDataKey.<Boolean>builder(PiglinDataKeys.class)
     ...
     * Supported versions: 1.16+
     */
    public static final EntityDataKey<Boolean> IS_CHARGING_CROSSBOW = EntityDataKey.<Boolean>builder(PiglinDataKeys.class)
     ...
     * Supported versions: 1.16+
     */
    public static final EntityDataKey<Boolean> IS_DANCING = EntityDataKey.<Boolean>builder(PiglinDataKeys.class)
