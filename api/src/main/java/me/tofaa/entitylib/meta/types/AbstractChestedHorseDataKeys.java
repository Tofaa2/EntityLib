 ...
 */
public class AbstractChestedHorseDataKeys extends AbstractHorseDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<Boolean> CHEST = EntityDataKey.<Boolean>builder(AbstractChestedHorseDataKeys.class)
