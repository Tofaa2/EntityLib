 ...
 */
public class EyeOfEnderMetaProperties extends EntityMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<ItemStack> ITEM_STACK = MetadataProperty.<ItemStack>builder(EyeOfEnderMetaProperties.class)
