 ...
 */
public class FireballMetaProperties extends AbstractHurtingProjectileMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<ItemStack> ITEM_STACK = MetadataProperty.<ItemStack>builder(FireballMetaProperties.class)
