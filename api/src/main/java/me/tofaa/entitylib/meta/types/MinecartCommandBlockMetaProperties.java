...
public class MinecartCommandBlockMetaProperties extends AbstractMinecartMetaProperties {
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<String> COMMAND_NAME = MetadataProperty.<String>builder(MinecartCommandBlockMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Component> LAST_OUTPUT = MetadataProperty.<Component>builder(MinecartCommandBlockMetaProperties.class)
