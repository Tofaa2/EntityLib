...
public class PigDataKeys extends AnimalDataKeys {
     ...
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Integer> BOOST_TIME = VersionedMetadataKey.<Integer>builder()
     ...
     */
    public static final VersionedMetadataKey<Boolean> SADDLE = VersionedMetadataKey.<Boolean>builder()
     ...
     */
    public static final VersionedMetadataKey<PigSoundVariant> SOUND_VARIANT = VersionedMetadataKey.<PigSoundVariant>builder()
            .add(ClientVersion.V_26_1, 20, EntityDataTypes.PIG_SOUND_VARIANT)
            .build();

    /**
     * Supported versions: 1.21.5+
     */
    public static final VersionedMetadataKey<PigVariant> VARIANT = VersionedMetadataKey.<PigVariant>builder()
            .add(ClientVersion.V_1_21_5, 18, EntityDataTypes.PIG_VARIANT)
            .add(ClientVersion.V_1_21_6, 18, EntityDataTypes.PIG_VARIANT)
            .add(ClientVersion.V_1_21_9, 18, EntityDataTypes.PIG_VARIANT)
            .add(ClientVersion.V_1_21_11, 18, EntityDataTypes.PIG_VARIANT)
            .add(ClientVersion.V_26_1, 19, EntityDataTypes.PIG_VARIANT)
            .build();
