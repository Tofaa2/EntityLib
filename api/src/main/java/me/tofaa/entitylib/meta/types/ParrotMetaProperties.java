 ...
 */
public class ParrotMetaProperties extends ShoulderRidingEntityMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> VARIANT = MetadataProperty.<Integer>builder(ParrotMetaProperties.class)
