 ...
 */
public class AbstractFishMetaProperties extends WaterAnimalMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> FROM_BUCKET = MetadataProperty.<Boolean>builder(AbstractFishMetaProperties.class)
