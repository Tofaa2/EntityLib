...
public class LlamaDataKeys extends AbstractChestedHorseDataKeys {
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> STRENGTH = EntityDataKey.<Integer>builder(LlamaDataKeys.class)
     ...
     */
    public static final EntityDataKey<Integer> SWAG = EntityDataKey.<Integer>builder(LlamaDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> VARIANT = EntityDataKey.<Integer>builder(LlamaDataKeys.class)
