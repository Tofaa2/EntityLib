...
public class PigMetaProperties extends AnimalMetaProperties {
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> BOOST_TIME = MetadataProperty.<Integer>builder(PigMetaProperties.class)
     ...
     */
    public static final SimpleProperty<Boolean> SADDLE = MetadataProperty.<Boolean>builder(PigMetaProperties.class)
     ...
     */
    public static final SimpleProperty<PigSoundVariant> SOUND_VARIANT = MetadataProperty.<PigSoundVariant>builder(PigMetaProperties.class)
     ...
     */
    public static final SimpleProperty<PigVariant> VARIANT = MetadataProperty.<PigVariant>builder(PigMetaProperties.class)
