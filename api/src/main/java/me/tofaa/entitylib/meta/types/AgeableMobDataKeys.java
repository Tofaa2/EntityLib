...
public class AgeableMobDataKeys extends PathfinderMobDataKeys {
     ...
     */
    public static final EntityDataKey<Boolean> AGE_LOCKED = EntityDataKey.<Boolean>builder(AgeableMobDataKeys.class)
     ...
     * Supported versions: 1.17+
     */
    public static final EntityDataKey<Boolean> BABY = EntityDataKey.<Boolean>builder(AgeableMobDataKeys.class)
