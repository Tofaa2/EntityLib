 ...
 */
public class EnderManDataKeys extends MonsterDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Integer> CARRY_STATE = VersionedMetadataKey.<Integer>builder()
            .add(ClientVersion.V_1_14_4, 14, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_15, 15, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_16, 15, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_16_2, 15, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_17, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_19, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_19_1, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_19_3, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_19_4, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_20_2, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_20_3, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_20_5, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_21, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_21_2, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_21_4, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_21_5, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_21_6, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_21_9, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_1_21_11, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .add(ClientVersion.V_26_1, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .build();

    /**
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Boolean> CREEPY = VersionedMetadataKey.<Boolean>builder()
     ...
     */
    public static final VersionedMetadataKey<Boolean> STARED_AT = VersionedMetadataKey.<Boolean>builder()
