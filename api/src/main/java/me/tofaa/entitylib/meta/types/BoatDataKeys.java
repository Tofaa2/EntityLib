 ...
 */
public class BoatDataKeys extends EntityDataKeys {

    /**
     * Supported versions: 1.21-
     */
    public static final VersionedMetadataKey<Integer> BUBBLE_TIME = VersionedMetadataKey.<Integer>builder()
            .add(ClientVersion.V_1_14_4, 13, EntityDataTypes.INT)
            .add(ClientVersion.V_1_15, 13, EntityDataTypes.INT)
            .add(ClientVersion.V_1_16, 13, EntityDataTypes.INT)
            .add(ClientVersion.V_1_16_2, 13, EntityDataTypes.INT)
            .add(ClientVersion.V_1_17, 14, EntityDataTypes.INT)
            .add(ClientVersion.V_1_19, 14, EntityDataTypes.INT)
            .add(ClientVersion.V_1_19_1, 14, EntityDataTypes.INT)
            .add(ClientVersion.V_1_19_3, 14, EntityDataTypes.INT)
            .add(ClientVersion.V_1_19_4, 14, EntityDataTypes.INT)
            .add(ClientVersion.V_1_20_2, 14, EntityDataTypes.INT)
            .add(ClientVersion.V_1_20_3, 14, EntityDataTypes.INT)
            .add(ClientVersion.V_1_20_5, 14, EntityDataTypes.INT)
            .add(ClientVersion.V_1_21, 14, EntityDataTypes.INT)
            .build();
    ...
    public static final VersionedMetadataKey<Boolean> PADDLE_LEFT = VersionedMetadataKey.<Boolean>builder()
            .add(ClientVersion.V_1_14_4, 11, EntityDataTypes.BOOLEAN)
            .add(ClientVersion.V_1_15, 11, EntityDataTypes.BOOLEAN)
            .add(ClientVersion.V_1_16, 11, EntityDataTypes.BOOLEAN)
            .add(ClientVersion.V_1_16_2, 11, EntityDataTypes.BOOLEAN)
            .add(ClientVersion.V_1_17, 12, EntityDataTypes.BOOLEAN)
            .add(ClientVersion.V_1_19, 12, EntityDataTypes.BOOLEAN)
            .add(ClientVersion.V_1_19_1, 12, EntityDataTypes.BOOLEAN)
            .add(ClientVersion.V_1_19_3, 12, EntityDataTypes.BOOLEAN)
            .add(ClientVersion.V_1_19_4, 12, EntityDataTypes.BOOLEAN)
            .add(ClientVersion.V_1_20_2, 12, EntityDataTypes.BOOLEAN)
            .add(ClientVersion.V_1_20_3, 12, EntityDataTypes.BOOLEAN)
            .add(ClientVersion.V_1_20_5, 12, EntityDataTypes.BOOLEAN)
            .add(ClientVersion.V_1_21, 12, EntityDataTypes.BOOLEAN)
            .build();
