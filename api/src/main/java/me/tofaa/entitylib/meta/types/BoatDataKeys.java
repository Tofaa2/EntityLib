...
public class BoatDataKeys extends EntityDataKeys {
     ...
     */
    public static final EntityDataKey<Integer> BUBBLE_TIME = EntityDataKey.<Integer>builder(BoatDataKeys.class)
     ...
     */
    public static final EntityDataKey<Float> DAMAGE = EntityDataKey.<Float>builder(BoatDataKeys.class)
     ...
     * Supported versions: 1.20.2-
     */
    public static final EntityDataKey<Integer> HURT = EntityDataKey.<Integer>builder(BoatDataKeys.class)
     ...
     * Supported versions: 1.20.2-
     */
    public static final EntityDataKey<Integer> HURTDIR = EntityDataKey.<Integer>builder(BoatDataKeys.class)
     ...
     * Supported versions: 1.21-
     */
    public static final EntityDataKey<Boolean> PADDLE_LEFT = EntityDataKey.<Boolean>builder(BoatDataKeys.class)
     ...
     * Supported versions: 1.21-
     */
    public static final EntityDataKey<Boolean> PADDLE_RIGHT = EntityDataKey.<Boolean>builder(BoatDataKeys.class)
     ...
     * Supported versions: 1.21-
     */
    public static final EntityDataKey<Integer> TYPE = EntityDataKey.<Integer>builder(BoatDataKeys.class)
