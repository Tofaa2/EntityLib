 ...
 */
public class ThrowableItemProjectileMetaProperties extends ThrowableProjectileMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<ItemStack> ITEM_STACK = MetadataProperty.<ItemStack>builder(ThrowableItemProjectileMetaProperties.class)
