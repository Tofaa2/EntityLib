...
public class ShulkerDataKeys extends AbstractGolemDataKeys {
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<BlockFace> ATTACH_FACE = EntityDataKey.<BlockFace>builder(ShulkerDataKeys.class)
     ...
     */
    public static final EntityDataKey<Optional<Vector3i>> ATTACH_POS = EntityDataKey.<Optional<Vector3i>>builder(ShulkerDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Byte> COLOR = EntityDataKey.<Byte>builder(ShulkerDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Byte> PEEK = EntityDataKey.<Byte>builder(ShulkerDataKeys.class)
