...
public class ArmorStandDataKeys extends LivingEntityDataKeys {
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Vector3f> BODY_POSE = EntityDataKey.<Vector3f>builder(ArmorStandDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Byte> CLIENT_FLAGS = EntityDataKey.<Byte>builder(ArmorStandDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Vector3f> HEAD_POSE = EntityDataKey.<Vector3f>builder(ArmorStandDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Vector3f> LEFT_ARM_POSE = EntityDataKey.<Vector3f>builder(ArmorStandDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Vector3f> LEFT_LEG_POSE = EntityDataKey.<Vector3f>builder(ArmorStandDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Vector3f> RIGHT_ARM_POSE = EntityDataKey.<Vector3f>builder(ArmorStandDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Vector3f> RIGHT_LEG_POSE = EntityDataKey.<Vector3f>builder(ArmorStandDataKeys.class)
