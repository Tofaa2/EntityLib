...
public class FrogMetaProperties extends AnimalMetaProperties {
     ...
     * Supported versions: 1.19+
     */
    public static final SimpleProperty<Optional<Integer>> TONGUE_TARGET = MetadataProperty.<Optional<Integer>>builder(FrogMetaProperties.class)
     ...
     * Supported versions: 1.19+
     */
    public static final SimpleProperty<FrogVariant> VARIANT = MetadataProperty.<FrogVariant>builder(FrogMetaProperties.class)
