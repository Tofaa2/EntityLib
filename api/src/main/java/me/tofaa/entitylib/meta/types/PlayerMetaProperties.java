 ...
 */
public class PlayerMetaProperties extends LivingEntityMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Float> PLAYER_ABSORPTION = MetadataProperty.<Float>builder(PlayerMetaProperties.class)
     ...
     */
    public static final SimpleProperty<Byte> PLAYER_MAIN_HAND = MetadataProperty.<Byte>builder(PlayerMetaProperties.class)
     ...
     * Supported versions: 1.21.6-
     */
    public static final SimpleProperty<Byte> PLAYER_MODE_CUSTOMISATION = MetadataProperty.<Byte>builder(PlayerMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> SCORE = MetadataProperty.<Integer>builder(PlayerMetaProperties.class)
     ...
     * Supported versions: 1.21.6-
     */
    public static final SimpleProperty<NBTCompound> SHOULDER_LEFT = MetadataProperty.<NBTCompound>builder(PlayerMetaProperties.class)
     ...
     */
    public static final SimpleProperty<Optional<Integer>> SHOULDER_PARROT_LEFT = MetadataProperty.<Optional<Integer>>builder(PlayerMetaProperties.class)
     ...
     * Supported versions: 1.21.9+
     */
    public static final SimpleProperty<Optional<Integer>> SHOULDER_PARROT_RIGHT = MetadataProperty.<Optional<Integer>>builder(PlayerMetaProperties.class)
     ...
     * Supported versions: 1.21.6-
     */
    public static final SimpleProperty<NBTCompound> SHOULDER_RIGHT = MetadataProperty.<NBTCompound>builder(PlayerMetaProperties.class)
