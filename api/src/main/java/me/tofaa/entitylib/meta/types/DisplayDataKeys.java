...
public class DisplayDataKeys extends EntityDataKeys {
     ...
     * Supported versions: 1.19.4+
     */
    public static final EntityDataKey<Byte> BILLBOARD_RENDER_CONSTRAINTS = EntityDataKey.<Byte>builder(DisplayDataKeys.class)
     ...
     * Supported versions: 1.19.4+
     */
    public static final EntityDataKey<Integer> BRIGHTNESS_OVERRIDE = EntityDataKey.<Integer>builder(DisplayDataKeys.class)
     ...
     * Supported versions: 1.19.4+
     */
    public static final EntityDataKey<Integer> GLOW_COLOR_OVERRIDE = EntityDataKey.<Integer>builder(DisplayDataKeys.class)
     ...
     * Supported versions: 1.19.4+
     */
    public static final EntityDataKey<Float> HEIGHT = EntityDataKey.<Float>builder(DisplayDataKeys.class)
     ...
     * Supported versions: 1.19.4
     */
    public static final EntityDataKey<Integer> INTERPOLATION_DURATION = EntityDataKey.<Integer>builder(DisplayDataKeys.class)
     ...
     * Supported versions: 1.19.4
     */
    public static final EntityDataKey<Integer> INTERPOLATION_START_DELTA_TICKS = EntityDataKey.<Integer>builder(DisplayDataKeys.class)
     ...
     */
    public static final EntityDataKey<Integer> POS_ROT_INTERPOLATION_DURATION = EntityDataKey.<Integer>builder(DisplayDataKeys.class)
     ...
     * Supported versions: 1.19.4+
     */
    public static final EntityDataKey<Float> SHADOW_RADIUS = EntityDataKey.<Float>builder(DisplayDataKeys.class)
     ...
     * Supported versions: 1.19.4+
     */
    public static final EntityDataKey<Float> SHADOW_STRENGTH = EntityDataKey.<Float>builder(DisplayDataKeys.class)
     ...
     * Supported versions: 1.20.2+
     */
    public static final EntityDataKey<Integer> TRANSFORMATION_INTERPOLATION_DURATION = EntityDataKey.<Integer>builder(DisplayDataKeys.class)
     ...
     * Supported versions: 1.20.2+
     */
    public static final EntityDataKey<Integer> TRANSFORMATION_INTERPOLATION_START_DELTA_TICKS = EntityDataKey.<Integer>builder(DisplayDataKeys.class)
     ...
     * Supported versions: 1.19.4+
     */
    public static final EntityDataKey<Float> VIEW_RANGE = EntityDataKey.<Float>builder(DisplayDataKeys.class)
     ...
     * Supported versions: 1.19.4+
     */
    public static final EntityDataKey<Float> WIDTH = EntityDataKey.<Float>builder(DisplayDataKeys.class)
