...
public class AllayDataKeys extends PathfinderMobDataKeys {
     ...
     */
    public static final EntityDataKey<Boolean> CAN_DUPLICATE = EntityDataKey.<Boolean>builder(AllayDataKeys.class)
     ...
     * Supported versions: 1.19.1+
     */
    public static final EntityDataKey<Boolean> DANCING = EntityDataKey.<Boolean>builder(AllayDataKeys.class)
