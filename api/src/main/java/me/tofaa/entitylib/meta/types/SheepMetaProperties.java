 ...
 */
public class SheepMetaProperties extends AnimalMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Byte> WOOL = MetadataProperty.<Byte>builder(SheepMetaProperties.class)
