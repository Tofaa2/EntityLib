...
public class ItemFrameMetaProperties extends HangingEntityMetaProperties {
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<ItemStack> ITEM = MetadataProperty.<ItemStack>builder(ItemFrameMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> ROTATION = MetadataProperty.<Integer>builder(ItemFrameMetaProperties.class)
