...
public class FishingHookDataKeys extends EntityDataKeys {
     ...
     */
    public static final EntityDataKey<Boolean> BITING = EntityDataKey.<Boolean>builder(FishingHookDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> HOOKED_ENTITY = EntityDataKey.<Integer>builder(FishingHookDataKeys.class)
