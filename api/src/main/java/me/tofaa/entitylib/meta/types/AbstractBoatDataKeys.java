...
public class AbstractBoatDataKeys extends VehicleEntityDataKeys {
     ...
     * Supported versions: 1.21.2+
     */
    public static final EntityDataKey<Integer> BUBBLE_TIME = EntityDataKey.<Integer>builder(AbstractBoatDataKeys.class)
     ...
     * Supported versions: 1.21.2+
     */
    public static final EntityDataKey<Boolean> PADDLE_LEFT = EntityDataKey.<Boolean>builder(AbstractBoatDataKeys.class)
     ...
     * Supported versions: 1.21.2+
     */
    public static final EntityDataKey<Boolean> PADDLE_RIGHT = EntityDataKey.<Boolean>builder(AbstractBoatDataKeys.class)
