 ...
 */
public class PufferfishDataKeys extends AbstractFishDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> PUFF_STATE = EntityDataKey.<Integer>builder(PufferfishDataKeys.class)
