...
public class WolfDataKeys extends TamableAnimalDataKeys {
    ...
    public static final VersionedMetadataKey<Long> ANGER_END_TIME = VersionedMetadataKey.<Long>builder()
            .add(ClientVersion.V_1_21_11, 21, EntityDataTypes.LONG)
            .add(ClientVersion.V_26_1, 22, EntityDataTypes.LONG)
            .build();
    ...
    public static final VersionedMetadataKey<Float> HEALTH = VersionedMetadataKey.<Float>builder()
            .add(ClientVersion.V_1_14_4, 17, EntityDataTypes.FLOAT)
            .build();

    /**
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Boolean> INTERESTED = VersionedMetadataKey.<Boolean>builder()
    ...
    public static final VersionedMetadataKey<Integer> REMAINING_ANGER_TIME = VersionedMetadataKey.<Integer>builder()
            ...
            .add(ClientVersion.V_1_20_5, 21, EntityDataTypes.INT)
            .add(ClientVersion.V_1_21, 21, EntityDataTypes.INT)
            .add(ClientVersion.V_1_21_2, 21, EntityDataTypes.INT)
            .add(ClientVersion.V_1_21_4, 21, EntityDataTypes.INT)
            .add(ClientVersion.V_1_21_5, 21, EntityDataTypes.INT)
            .add(ClientVersion.V_1_21_6, 21, EntityDataTypes.INT)
            .add(ClientVersion.V_1_21_9, 21, EntityDataTypes.INT)
            .build();

    /**
     * Supported versions: 1.21.5+
     */
    public static final VersionedMetadataKey<WolfSoundVariant> SOUND_VARIANT = VersionedMetadataKey.<WolfSoundVariant>builder()
            .add(ClientVersion.V_1_21_5, 23, EntityDataTypes.WOLF_SOUND_VARIANT)
            .add(ClientVersion.V_1_21_6, 23, EntityDataTypes.WOLF_SOUND_VARIANT)
            .add(ClientVersion.V_1_21_9, 23, EntityDataTypes.WOLF_SOUND_VARIANT)
            .add(ClientVersion.V_1_21_11, 23, EntityDataTypes.WOLF_SOUND_VARIANT)
            .add(ClientVersion.V_26_1, 24, EntityDataTypes.WOLF_SOUND_VARIANT)
            .build();

    /**
     * Supported versions: 1.20.5+
     */
    public static final VersionedMetadataKey<WolfVariant> VARIANT = VersionedMetadataKey.<WolfVariant>builder()
            .add(ClientVersion.V_1_20_5, 22, EntityDataTypes.TYPED_WOLF_VARIANT)
            .add(ClientVersion.V_1_21, 22, EntityDataTypes.TYPED_WOLF_VARIANT)
            .add(ClientVersion.V_1_21_2, 22, EntityDataTypes.TYPED_WOLF_VARIANT)
            .add(ClientVersion.V_1_21_4, 22, EntityDataTypes.TYPED_WOLF_VARIANT)
            .add(ClientVersion.V_1_21_5, 22, EntityDataTypes.TYPED_WOLF_VARIANT)
            .add(ClientVersion.V_1_21_6, 22, EntityDataTypes.TYPED_WOLF_VARIANT)
            .add(ClientVersion.V_1_21_9, 22, EntityDataTypes.TYPED_WOLF_VARIANT)
            .add(ClientVersion.V_1_21_11, 22, EntityDataTypes.TYPED_WOLF_VARIANT)
            .add(ClientVersion.V_26_1, 23, EntityDataTypes.TYPED_WOLF_VARIANT)
            .build();
