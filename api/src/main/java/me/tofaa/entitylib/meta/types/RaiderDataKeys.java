 ...
 */
public class RaiderDataKeys extends PatrollingMonsterDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<Boolean> IS_CELEBRATING = EntityDataKey.<Boolean>builder(RaiderDataKeys.class)
