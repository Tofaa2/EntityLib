 ...
 */
public class WitchDataKeys extends RaiderDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<Boolean> USING_ITEM = EntityDataKey.<Boolean>builder(WitchDataKeys.class)
