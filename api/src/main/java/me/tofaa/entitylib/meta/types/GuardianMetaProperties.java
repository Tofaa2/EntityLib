 ...
 */
public class GuardianMetaProperties extends MonsterMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> ATTACK_TARGET = MetadataProperty.<Integer>builder(GuardianMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> MOVING = MetadataProperty.<Boolean>builder(GuardianMetaProperties.class)
