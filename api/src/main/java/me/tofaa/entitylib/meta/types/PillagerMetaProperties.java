 ...
 */
public class PillagerMetaProperties extends AbstractIllagerMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> IS_CHARGING_CROSSBOW = MetadataProperty.<Boolean>builder(PillagerMetaProperties.class)
