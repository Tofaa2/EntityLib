 ...
 */
public class TropicalFishDataKeys extends AbstractSchoolingFishDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> TYPE_VARIANT = EntityDataKey.<Integer>builder(TropicalFishDataKeys.class)
