...
public class ItemFrameDataKeys extends HangingEntityDataKeys {
     ...
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<ItemStack> ITEM = VersionedMetadataKey.<ItemStack>builder()
            ...
            .add(ClientVersion.V_1_21_6, 9, EntityDataTypes.ITEMSTACK)
            .add(ClientVersion.V_1_21_9, 9, EntityDataTypes.ITEMSTACK)
            .add(ClientVersion.V_1_21_11, 9, EntityDataTypes.ITEMSTACK)
            .add(ClientVersion.V_26_1, 9, EntityDataTypes.ITEMSTACK)
            .build();

    /**
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Integer> ROTATION = VersionedMetadataKey.<Integer>builder()
