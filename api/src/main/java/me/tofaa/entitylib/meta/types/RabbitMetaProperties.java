 ...
 */
public class RabbitMetaProperties extends AnimalMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> TYPE = MetadataProperty.<Integer>builder(RabbitMetaProperties.class)
