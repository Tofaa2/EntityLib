...
public class AxolotlMetaProperties extends AnimalMetaProperties {
     ...
     * Supported versions: 1.17+
     */
    public static final SimpleProperty<Boolean> FROM_BUCKET = MetadataProperty.<Boolean>builder(AxolotlMetaProperties.class)
     ...
     * Supported versions: 1.17+
     */
    public static final SimpleProperty<Boolean> PLAYING_DEAD = MetadataProperty.<Boolean>builder(AxolotlMetaProperties.class)
