 ...
 */
public class EyeOfEnderDataKeys extends EntityDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<ItemStack> ITEM_STACK = EntityDataKey.<ItemStack>builder(EyeOfEnderDataKeys.class)
