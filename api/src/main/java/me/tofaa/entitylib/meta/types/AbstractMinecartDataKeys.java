...
public class AbstractMinecartDataKeys extends EntityDataKeys {
     ...
     */
    public static final EntityDataKey<Boolean> CUSTOM_DISPLAY = EntityDataKey.<Boolean>builder(AbstractMinecartDataKeys.class)
     ...
     */
    public static final EntityDataKey<Integer> CUSTOM_DISPLAY_BLOCK = EntityDataKey.<Integer>builder(AbstractMinecartDataKeys.class)
     ...
     */
    public static final EntityDataKey<Float> DAMAGE = EntityDataKey.<Float>builder(AbstractMinecartDataKeys.class)
     ...
     * Supported versions: 1.21.4-
     */
    public static final EntityDataKey<Integer> DISPLAY_BLOCK = EntityDataKey.<Integer>builder(AbstractMinecartDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> DISPLAY_OFFSET = EntityDataKey.<Integer>builder(AbstractMinecartDataKeys.class)
     ...
     * Supported versions: 1.20.2-
     */
    public static final EntityDataKey<Integer> HURT = EntityDataKey.<Integer>builder(AbstractMinecartDataKeys.class)
     ...
     * Supported versions: 1.20.2-
     */
    public static final EntityDataKey<Integer> HURTDIR = EntityDataKey.<Integer>builder(AbstractMinecartDataKeys.class)
