 ...
 */
public class GhastMetaProperties extends FlyingMobMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> IS_CHARGING = MetadataProperty.<Boolean>builder(GhastMetaProperties.class)
