 ...
 */
public class PolarBearMetaProperties extends AnimalMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> STANDING = MetadataProperty.<Boolean>builder(PolarBearMetaProperties.class)
