...
public class InteractionMetaProperties extends EntityMetaProperties {
     ...
     * Supported versions: 1.19.4+
     */
    public static final SimpleProperty<Float> HEIGHT = MetadataProperty.<Float>builder(InteractionMetaProperties.class)
     ...
     * Supported versions: 1.19.4+
     */
    public static final SimpleProperty<Boolean> RESPONSE = MetadataProperty.<Boolean>builder(InteractionMetaProperties.class)
     ...
     * Supported versions: 1.19.4+
     */
    public static final SimpleProperty<Float> WIDTH = MetadataProperty.<Float>builder(InteractionMetaProperties.class)
