 ...
 */
public class PolarBearDataKeys extends AnimalDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<Boolean> STANDING = EntityDataKey.<Boolean>builder(PolarBearDataKeys.class)
