 ...
 */
public class HoglinMetaProperties extends AnimalMetaProperties {

    /**
     * Supported versions: 1.16+
     */
    public static final SimpleProperty<Boolean> IMMUNE_TO_ZOMBIFICATION = MetadataProperty.<Boolean>builder(HoglinMetaProperties.class)
