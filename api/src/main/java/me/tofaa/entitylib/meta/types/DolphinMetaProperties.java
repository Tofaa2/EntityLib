 ...
 */
public class DolphinMetaProperties extends WaterAnimalMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> GOT_FISH = MetadataProperty.<Boolean>builder(DolphinMetaProperties.class)
     ...
     */
    public static final SimpleProperty<Integer> MOISNTESS_LEVEL = MetadataProperty.<Integer>builder(DolphinMetaProperties.class)
     ...
     */
    public static final SimpleProperty<Integer> MOISTNESS_LEVEL = MetadataProperty.<Integer>builder(DolphinMetaProperties.class)
     ...
     */
    public static final SimpleProperty<Vector3i> TREASURE_POS = MetadataProperty.<Vector3i>builder(DolphinMetaProperties.class)
