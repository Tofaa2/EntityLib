...
public class TextDisplayDataKeys extends DisplayDataKeys {
     ...
     * Supported versions: 1.19.4+
     */
    public static final EntityDataKey<Integer> BACKGROUND_COLOR = EntityDataKey.<Integer>builder(TextDisplayDataKeys.class)
     ...
     * Supported versions: 1.19.4+
     */
    public static final EntityDataKey<Integer> LINE_WIDTH = EntityDataKey.<Integer>builder(TextDisplayDataKeys.class)
     ...
     * Supported versions: 1.19.4+
     */
    public static final EntityDataKey<Byte> STYLE_FLAGS = EntityDataKey.<Byte>builder(TextDisplayDataKeys.class)
     ...
     * Supported versions: 1.19.4+
     */
    public static final EntityDataKey<Component> TEXT = EntityDataKey.<Component>builder(TextDisplayDataKeys.class)
     ...
     * Supported versions: 1.19.4+
     */
    public static final EntityDataKey<Byte> TEXT_OPACITY = EntityDataKey.<Byte>builder(TextDisplayDataKeys.class)
