...
public class VehicleEntityDataKeys extends EntityDataKeys {
     ...
     * Supported versions: 1.20.3+
     */
    public static final EntityDataKey<Float> DAMAGE = EntityDataKey.<Float>builder(VehicleEntityDataKeys.class)
     ...
     * Supported versions: 1.20.3+
     */
    public static final EntityDataKey<Integer> HURT = EntityDataKey.<Integer>builder(VehicleEntityDataKeys.class)
     ...
     * Supported versions: 1.20.3+
     */
    public static final EntityDataKey<Integer> HURTDIR = EntityDataKey.<Integer>builder(VehicleEntityDataKeys.class)
