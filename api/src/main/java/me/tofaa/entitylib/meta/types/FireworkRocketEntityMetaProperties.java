 ...
 */
public class FireworkRocketEntityMetaProperties extends EntityMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Optional<Integer>> ATTACHED_TO_TARGET = MetadataProperty.<Optional<Integer>>builder(FireworkRocketEntityMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<ItemStack> FIREWORKS_ITEM = MetadataProperty.<ItemStack>builder(FireworkRocketEntityMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> SHOT_AT_ANGLE = MetadataProperty.<Boolean>builder(FireworkRocketEntityMetaProperties.class)
