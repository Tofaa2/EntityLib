...
public class VillagerDataKeys extends AbstractVillagerDataKeys {
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<VillagerData> VILLAGER_DATA = EntityDataKey.<VillagerData>builder(VillagerDataKeys.class)
     ...
     */
    public static final EntityDataKey<Boolean> VILLAGER_FINALIZED = EntityDataKey.<Boolean>builder(VillagerDataKeys.class)
