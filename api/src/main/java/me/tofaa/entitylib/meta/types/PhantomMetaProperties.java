 ...
 */
public class PhantomMetaProperties extends FlyingMobMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> ID_SIZE = MetadataProperty.<Integer>builder(PhantomMetaProperties.class)
