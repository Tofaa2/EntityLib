 ...
 */
public class SnowGolemDataKeys extends AbstractGolemDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<Byte> PUMPKIN = EntityDataKey.<Byte>builder(SnowGolemDataKeys.class)
