 ...
 */
public class ItemEntityMetaProperties extends EntityMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<ItemStack> ITEM = MetadataProperty.<ItemStack>builder(ItemEntityMetaProperties.class)
