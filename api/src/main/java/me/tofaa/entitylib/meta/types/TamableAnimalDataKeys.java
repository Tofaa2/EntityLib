...
public class TamableAnimalDataKeys extends AnimalDataKeys {
    ...
    public static final VersionedMetadataKey<Optional<UUID>> OWNERUUID = VersionedMetadataKey.<Optional<UUID>>builder()
            ...
            .add(ClientVersion.V_1_19_4, 18, EntityDataTypes.OPTIONAL_UUID)
            .add(ClientVersion.V_1_20_2, 18, EntityDataTypes.OPTIONAL_UUID)
            .add(ClientVersion.V_1_20_3, 18, EntityDataTypes.OPTIONAL_UUID)
            .add(ClientVersion.V_1_20_5, 18, EntityDataTypes.OPTIONAL_UUID)
            .add(ClientVersion.V_1_21, 18, EntityDataTypes.OPTIONAL_UUID)
            .add(ClientVersion.V_1_21_2, 18, EntityDataTypes.OPTIONAL_UUID)
            .add(ClientVersion.V_1_21_4, 18, EntityDataTypes.OPTIONAL_UUID)
            .add(ClientVersion.V_1_21_5, 18, EntityDataTypes.OPTIONAL_UUID)
            .add(ClientVersion.V_1_21_6, 18, EntityDataTypes.OPTIONAL_UUID)
            .add(ClientVersion.V_1_21_9, 18, EntityDataTypes.OPTIONAL_UUID)
            .add(ClientVersion.V_1_21_11, 18, EntityDataTypes.OPTIONAL_UUID)
            .add(ClientVersion.V_26_1, 19, EntityDataTypes.OPTIONAL_UUID)
            .build();
