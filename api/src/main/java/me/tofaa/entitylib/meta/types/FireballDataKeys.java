 ...
 */
public class FireballDataKeys extends AbstractHurtingProjectileDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<ItemStack> ITEM_STACK = EntityDataKey.<ItemStack>builder(FireballDataKeys.class)
