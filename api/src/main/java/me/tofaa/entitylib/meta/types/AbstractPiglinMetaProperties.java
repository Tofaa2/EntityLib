 ...
 */
public class AbstractPiglinMetaProperties extends MonsterMetaProperties {

    /**
     * Supported versions: 1.16.2+
     */
    public static final SimpleProperty<Boolean> IMMUNE_TO_ZOMBIFICATION = MetadataProperty.<Boolean>builder(AbstractPiglinMetaProperties.class)
