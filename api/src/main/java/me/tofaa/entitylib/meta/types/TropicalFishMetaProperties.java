 ...
 */
public class TropicalFishMetaProperties extends AbstractSchoolingFishMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> TYPE_VARIANT = MetadataProperty.<Integer>builder(TropicalFishMetaProperties.class)
