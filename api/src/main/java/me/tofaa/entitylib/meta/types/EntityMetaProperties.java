 ...
 */
public class EntityMetaProperties implements IMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> AIR_SUPPLY = MetadataProperty.<Integer>builder(EntityMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Optional<Component>> CUSTOM_NAME = MetadataProperty.<Optional<Component>>builder(EntityMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> CUSTOM_NAME_VISIBLE = MetadataProperty.<Boolean>builder(EntityMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> NO_GRAVITY = MetadataProperty.<Boolean>builder(EntityMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<EntityPose> POSE = MetadataProperty.<EntityPose>builder(EntityMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> SILENT = MetadataProperty.<Boolean>builder(EntityMetaProperties.class)
     ...
     */
    public static final SimpleProperty<Integer> TICKS_FROZEN = MetadataProperty.<Integer>builder(EntityMetaProperties.class)
