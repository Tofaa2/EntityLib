 ...
 */
public class IronGolemDataKeys extends AbstractGolemDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<Byte> FLAGS = EntityDataKey.<Byte>builder(IronGolemDataKeys.class)
