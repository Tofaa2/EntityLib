...
public class PandaDataKeys extends AnimalDataKeys {
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> EAT_COUNTER = EntityDataKey.<Integer>builder(PandaDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Byte> FLAGS = EntityDataKey.<Byte>builder(PandaDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Byte> HIDDEN_GENE = EntityDataKey.<Byte>builder(PandaDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Byte> MAIN_GENE = EntityDataKey.<Byte>builder(PandaDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> SNEEZE_COUNTER = EntityDataKey.<Integer>builder(PandaDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> UNHAPPY_COUNTER = EntityDataKey.<Integer>builder(PandaDataKeys.class)
