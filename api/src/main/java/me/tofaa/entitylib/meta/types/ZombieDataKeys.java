...
public class ZombieDataKeys extends MonsterDataKeys {
     ...
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Boolean> DROWNED_CONVERSION = VersionedMetadataKey.<Boolean>builder()
     ...
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Integer> SPECIAL_TYPE = VersionedMetadataKey.<Integer>builder()
