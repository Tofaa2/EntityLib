 ...
 */
public class ZombieDataKeys extends MonsterDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<Boolean> BABY = EntityDataKey.<Boolean>builder(ZombieDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Boolean> DROWNED_CONVERSION = EntityDataKey.<Boolean>builder(ZombieDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> SPECIAL_TYPE = EntityDataKey.<Integer>builder(ZombieDataKeys.class)
