 ...
 */
public class WitherBossMetaProperties extends MonsterMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> INV = MetadataProperty.<Integer>builder(WitherBossMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> TARGET_A = MetadataProperty.<Integer>builder(WitherBossMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> TARGET_B = MetadataProperty.<Integer>builder(WitherBossMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> TARGET_C = MetadataProperty.<Integer>builder(WitherBossMetaProperties.class)
