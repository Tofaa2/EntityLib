...
public class AreaEffectCloudDataKeys extends EntityDataKeys {
     ...
     */
    public static final EntityDataKey<Integer> COLOR = EntityDataKey.<Integer>builder(AreaEffectCloudDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Particle<?>> PARTICLE = EntityDataKey.<Particle<?>>builder(AreaEffectCloudDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Float> RADIUS = EntityDataKey.<Float>builder(AreaEffectCloudDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Boolean> WAITING = EntityDataKey.<Boolean>builder(AreaEffectCloudDataKeys.class)
