 ...
 */
public class AreaEffectCloudDataKeys extends EntityDataKeys {

    /**
     * Supported versions: 1.20.3-
     */
    public static final VersionedMetadataKey<Integer> COLOR = VersionedMetadataKey.<Integer>builder()
     ...
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Particle<?>> PARTICLE = VersionedMetadataKey.<Particle<?>>builder()
            .add(ClientVersion.V_1_14_4, 10, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_15, 10, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_16, 10, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_16_2, 10, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_17, 11, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_19, 11, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_19_1, 11, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_19_3, 11, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_19_4, 11, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_20_2, 11, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_20_3, 11, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_20_5, 10, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_21, 10, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_21_2, 10, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_21_4, 10, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_21_5, 10, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_21_6, 10, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_21_9, 10, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_1_21_11, 10, EntityDataTypes.PARTICLE)
            .add(ClientVersion.V_26_1, 10, EntityDataTypes.PARTICLE)
            .build();

    /**
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Float> RADIUS = VersionedMetadataKey.<Float>builder()
            .add(ClientVersion.V_1_14_4, 7, EntityDataTypes.FLOAT)
            .add(ClientVersion.V_1_15, 7, EntityDataTypes.FLOAT)
            .add(ClientVersion.V_1_16, 7, EntityDataTypes.FLOAT)
            .add(ClientVersion.V_1_16_2, 7, EntityDataTypes.FLOAT)
            .add(ClientVersion.V_1_17, 8, EntityDataTypes.FLOAT)
            .add(ClientVersion.V_1_19, 8, EntityDataTypes.FLOAT)
            .add(ClientVersion.V_1_19_1, 8, EntityDataTypes.FLOAT)
            .add(ClientVersion.V_1_19_3, 8, EntityDataTypes.FLOAT)
     ...
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Boolean> WAITING = VersionedMetadataKey.<Boolean>builder()
