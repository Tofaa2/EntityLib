...
public class FireworkRocketEntityDataKeys extends EntityDataKeys {
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Optional<Integer>> ATTACHED_TO_TARGET = EntityDataKey.<Optional<Integer>>builder(FireworkRocketEntityDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<ItemStack> FIREWORKS_ITEM = EntityDataKey.<ItemStack>builder(FireworkRocketEntityDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Boolean> SHOT_AT_ANGLE = EntityDataKey.<Boolean>builder(FireworkRocketEntityDataKeys.class)
