 ...
 */
public class AbstractVillagerMetaProperties extends AgableMobMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> UNHAPPY_COUNTER = MetadataProperty.<Integer>builder(AbstractVillagerMetaProperties.class)
