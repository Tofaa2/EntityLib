 ...
 */
public class SpellcasterIllagerDataKeys extends AbstractIllagerDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Byte> SPELL_CASTING = VersionedMetadataKey.<Byte>builder()
