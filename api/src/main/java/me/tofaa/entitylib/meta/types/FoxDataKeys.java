...
public class FoxDataKeys extends AnimalDataKeys {
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Byte> FLAGS = EntityDataKey.<Byte>builder(FoxDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> TYPE = EntityDataKey.<Integer>builder(FoxDataKeys.class)
