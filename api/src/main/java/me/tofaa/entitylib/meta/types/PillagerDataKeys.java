 ...
 */
public class PillagerDataKeys extends AbstractIllagerDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<Boolean> IS_CHARGING_CROSSBOW = EntityDataKey.<Boolean>builder(PillagerDataKeys.class)
