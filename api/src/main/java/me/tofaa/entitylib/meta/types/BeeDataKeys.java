...
public class BeeDataKeys extends AnimalDataKeys {
     ...
     */
    public static final EntityDataKey<Long> ANGER_END_TIME = EntityDataKey.<Long>builder(BeeDataKeys.class)
     ...
     * Supported versions: 1.15
     */
    public static final EntityDataKey<Integer> ANGER_TIME = EntityDataKey.<Integer>builder(BeeDataKeys.class)
     ...
     * Supported versions: 1.15+
     */
    public static final EntityDataKey<Byte> FLAGS = EntityDataKey.<Byte>builder(BeeDataKeys.class)
     ...
     */
    public static final EntityDataKey<Integer> REMAINING_ANGER_TIME = EntityDataKey.<Integer>builder(BeeDataKeys.class)
