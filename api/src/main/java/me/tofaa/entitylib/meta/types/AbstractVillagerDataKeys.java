 ...
 */
public class AbstractVillagerDataKeys extends AgableMobDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> UNHAPPY_COUNTER = EntityDataKey.<Integer>builder(AbstractVillagerDataKeys.class)
