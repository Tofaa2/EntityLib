...
public class CatMetaProperties extends TamableAnimalMetaProperties {
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> COLLAR_COLOR = MetadataProperty.<Integer>builder(CatMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> IS_LYING = MetadataProperty.<Boolean>builder(CatMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> RELAX_STATE_ONE = MetadataProperty.<Boolean>builder(CatMetaProperties.class)
     ...
     */
    public static final SimpleProperty<CatSoundVariant> SOUND_VARIANT = MetadataProperty.<CatSoundVariant>builder(CatMetaProperties.class)
     ...
     */
    public static final SimpleProperty<Integer> TYPE = MetadataProperty.<Integer>builder(CatMetaProperties.class)
     ...
     */
    public static final SimpleProperty<CatVariant> VARIANT = MetadataProperty.<CatVariant>builder(CatMetaProperties.class)
