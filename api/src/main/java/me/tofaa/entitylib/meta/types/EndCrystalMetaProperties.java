...
public class EndCrystalMetaProperties extends EntityMetaProperties {
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Optional<Vector3i>> BEAM_TARGET = MetadataProperty.<Optional<Vector3i>>builder(EndCrystalMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> SHOW_BOTTOM = MetadataProperty.<Boolean>builder(EndCrystalMetaProperties.class)
