...
public class TamableAnimalMetaProperties extends AnimalMetaProperties {
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Byte> FLAGS = MetadataProperty.<Byte>builder(TamableAnimalMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Optional<UUID>> OWNERUUID = MetadataProperty.<Optional<UUID>>builder(TamableAnimalMetaProperties.class)
