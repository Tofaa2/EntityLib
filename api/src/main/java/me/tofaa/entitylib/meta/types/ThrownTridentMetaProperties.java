...
public class ThrownTridentMetaProperties extends AbstractArrowMetaProperties {
     ...
     */
    public static final SimpleProperty<Boolean> ID_FOIL = MetadataProperty.<Boolean>builder(ThrownTridentMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Byte> ID_LOYALTY = MetadataProperty.<Byte>builder(ThrownTridentMetaProperties.class)
