...
public class WitherBossDataKeys extends MonsterDataKeys {
     ...
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Integer> INV = VersionedMetadataKey.<Integer>builder()
     ...
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Integer> TARGET_A = VersionedMetadataKey.<Integer>builder()
     ...
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Integer> TARGET_B = VersionedMetadataKey.<Integer>builder()
     ...
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Integer> TARGET_C = VersionedMetadataKey.<Integer>builder()
