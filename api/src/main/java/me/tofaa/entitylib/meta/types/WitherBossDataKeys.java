 ...
 */
public class WitherBossDataKeys extends MonsterDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> INV = EntityDataKey.<Integer>builder(WitherBossDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> TARGET_A = EntityDataKey.<Integer>builder(WitherBossDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> TARGET_B = EntityDataKey.<Integer>builder(WitherBossDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> TARGET_C = EntityDataKey.<Integer>builder(WitherBossDataKeys.class)
