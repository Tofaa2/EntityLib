 ...
 */
public class OcelotMetaProperties extends AnimalMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> TRUSTING = MetadataProperty.<Boolean>builder(OcelotMetaProperties.class)
