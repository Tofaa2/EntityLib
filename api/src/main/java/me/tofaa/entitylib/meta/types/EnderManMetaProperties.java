...
public class EnderManMetaProperties extends MonsterMetaProperties {
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> CARRY_STATE = MetadataProperty.<Integer>builder(EnderManMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> CREEPY = MetadataProperty.<Boolean>builder(EnderManMetaProperties.class)
     ...
     */
    public static final SimpleProperty<Boolean> STARED_AT = MetadataProperty.<Boolean>builder(EnderManMetaProperties.class)
