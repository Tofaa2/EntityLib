 ...
 */
public class CreeperDataKeys extends MonsterDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Boolean> IS_IGNITED = VersionedMetadataKey.<Boolean>builder()
     ...
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Boolean> IS_POWERED = VersionedMetadataKey.<Boolean>builder()
     ...
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Integer> SWELL_DIR = VersionedMetadataKey.<Integer>builder()
