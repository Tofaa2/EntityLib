...
public class CreeperDataKeys extends MonsterDataKeys {
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Boolean> IS_IGNITED = EntityDataKey.<Boolean>builder(CreeperDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Boolean> IS_POWERED = EntityDataKey.<Boolean>builder(CreeperDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> SWELL_DIR = EntityDataKey.<Integer>builder(CreeperDataKeys.class)
