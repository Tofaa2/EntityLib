...
public class FoxMetaProperties extends AnimalMetaProperties {
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Byte> FLAGS = MetadataProperty.<Byte>builder(FoxMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Optional<UUID>> TRUSTED_0 = MetadataProperty.<Optional<UUID>>builder(FoxMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Optional<UUID>> TRUSTED_1 = MetadataProperty.<Optional<UUID>>builder(FoxMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> TYPE = MetadataProperty.<Integer>builder(FoxMetaProperties.class)
