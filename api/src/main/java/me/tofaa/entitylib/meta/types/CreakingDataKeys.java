...
public class CreakingDataKeys extends MonsterDataKeys {
     ...
     * Supported versions: 1.21.2+
     */
    public static final EntityDataKey<Boolean> CAN_MOVE = EntityDataKey.<Boolean>builder(CreakingDataKeys.class)
     ...
     */
    public static final EntityDataKey<Optional<Vector3i>> HOME_POS = EntityDataKey.<Optional<Vector3i>>builder(CreakingDataKeys.class)
     ...
     * Supported versions: 1.21.2+
     */
    public static final EntityDataKey<Boolean> IS_ACTIVE = EntityDataKey.<Boolean>builder(CreakingDataKeys.class)
     ...
     * Supported versions: 1.21.4+
     */
    public static final EntityDataKey<Boolean> IS_TEARING_DOWN = EntityDataKey.<Boolean>builder(CreakingDataKeys.class)
