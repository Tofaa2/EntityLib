...
public class CamelDataKeys extends AbstractHorseDataKeys {
     ...
     * Supported versions: 1.19.3+
     */
    public static final EntityDataKey<Boolean> DASH = EntityDataKey.<Boolean>builder(CamelDataKeys.class)
     ...
     * Supported versions: 1.19.3+
     */
    public static final EntityDataKey<Long> LAST_POSE_CHANGE_TICK = EntityDataKey.<Long>builder(CamelDataKeys.class)
