 ...
 */
public class TurtleMetaProperties extends AnimalMetaProperties {

    /**
     * Supported versions: 1.21.4-
     */
    public static final SimpleProperty<Boolean> GOING_HOME = MetadataProperty.<Boolean>builder(TurtleMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> HAS_EGG = MetadataProperty.<Boolean>builder(TurtleMetaProperties.class)
     ...
     * Supported versions: 1.21.4-
     */
    public static final SimpleProperty<Vector3i> HOME_POS = MetadataProperty.<Vector3i>builder(TurtleMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> LAYING_EGG = MetadataProperty.<Boolean>builder(TurtleMetaProperties.class)
     ...
     * Supported versions: 1.21.4-
     */
    public static final SimpleProperty<Boolean> TRAVELLING = MetadataProperty.<Boolean>builder(TurtleMetaProperties.class)
     ...
     * Supported versions: 1.21.4-
     */
    public static final SimpleProperty<Vector3i> TRAVEL_POS = MetadataProperty.<Vector3i>builder(TurtleMetaProperties.class)
