...
public class StriderMetaProperties extends AnimalMetaProperties {
     ...
     * Supported versions: 1.16+
     */
    public static final SimpleProperty<Integer> BOOST_TIME = MetadataProperty.<Integer>builder(StriderMetaProperties.class)
    ...
    /**
     * Supported versions: 1.16 - 1.21.4
     */
    public static final SimpleProperty<Boolean> SADDLE = MetadataProperty.<Boolean>builder(StriderMetaProperties.class)
     ...
     * Supported versions: 1.16+
     */
    public static final SimpleProperty<Boolean> SUFFOCATING = MetadataProperty.<Boolean>builder(StriderMetaProperties.class)
