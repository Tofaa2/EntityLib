 ...
 */
public class SlimeMetaProperties extends MobMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> ID_SIZE = MetadataProperty.<Integer>builder(SlimeMetaProperties.class)
