...
public class GoatDataKeys extends AnimalDataKeys {
     ...
     */
    public static final EntityDataKey<Boolean> HAS_LEFT_HORN = EntityDataKey.<Boolean>builder(GoatDataKeys.class)
     ...
     * Supported versions: 1.19+
     */
    public static final EntityDataKey<Boolean> HAS_RIGHT_HORN = EntityDataKey.<Boolean>builder(GoatDataKeys.class)
     ...
     * Supported versions: 1.17+
     */
    public static final EntityDataKey<Boolean> IS_SCREAMING_GOAT = EntityDataKey.<Boolean>builder(GoatDataKeys.class)
