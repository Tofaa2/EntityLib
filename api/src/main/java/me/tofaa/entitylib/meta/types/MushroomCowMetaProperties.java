 ...
 */
public class MushroomCowMetaProperties extends CowMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> TYPE = MetadataProperty.<Integer>builder(MushroomCowMetaProperties.class)
