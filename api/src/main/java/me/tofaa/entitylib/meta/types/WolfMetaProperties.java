...
public class WolfMetaProperties extends TamableAnimalMetaProperties {
     ...
     */
    public static final SimpleProperty<Long> ANGER_END_TIME = MetadataProperty.<Long>builder(WolfMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> COLLAR_COLOR = MetadataProperty.<Integer>builder(WolfMetaProperties.class)
     ...
     */
    public static final SimpleProperty<Float> HEALTH = MetadataProperty.<Float>builder(WolfMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> INTERESTED = MetadataProperty.<Boolean>builder(WolfMetaProperties.class)
     ...
     */
    public static final SimpleProperty<Integer> REMAINING_ANGER_TIME = MetadataProperty.<Integer>builder(WolfMetaProperties.class)
     ...
     */
    public static final SimpleProperty<WolfSoundVariant> SOUND_VARIANT = MetadataProperty.<WolfSoundVariant>builder(WolfMetaProperties.class)
     ...
     */
    public static final SimpleProperty<WolfVariant> VARIANT = MetadataProperty.<WolfVariant>builder(WolfMetaProperties.class)
