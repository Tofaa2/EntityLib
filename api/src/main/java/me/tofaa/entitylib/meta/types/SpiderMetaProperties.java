 ...
 */
public class SpiderMetaProperties extends MonsterMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Byte> FLAGS = MetadataProperty.<Byte>builder(SpiderMetaProperties.class)
