 ...
 */
public class SkeletonDataKeys extends AbstractSkeletonDataKeys {

    /**
     * Supported versions: 1.17+
     */
    public static final EntityDataKey<Boolean> STRAY_CONVERSION = EntityDataKey.<Boolean>builder(SkeletonDataKeys.class)
