 ...
 */
public class GuardianDataKeys extends MonsterDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Integer> ATTACK_TARGET = VersionedMetadataKey.<Integer>builder()
     ...
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Boolean> MOVING = VersionedMetadataKey.<Boolean>builder()
