...
public class AgeableMobMetaProperties extends PathfinderMobMetaProperties {
     ...
     */
    public static final SimpleProperty<Boolean> AGE_LOCKED = MetadataProperty.<Boolean>builder(AgeableMobMetaProperties.class)
     ...
     * Supported versions: 1.17+
     */
    public static final SimpleProperty<Boolean> BABY = MetadataProperty.<Boolean>builder(AgeableMobMetaProperties.class)
