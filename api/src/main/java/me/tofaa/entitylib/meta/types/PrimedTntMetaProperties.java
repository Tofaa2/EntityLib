...
public class PrimedTntMetaProperties extends EntityMetaProperties {
     ...
     */
    public static final SimpleProperty<Integer> BLOCK_STATE = MetadataProperty.<Integer>builder(PrimedTntMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> FUSE = MetadataProperty.<Integer>builder(PrimedTntMetaProperties.class)
