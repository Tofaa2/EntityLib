...
public class AbstractArrowDataKeys extends EntityDataKeys {
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Byte> ID_FLAGS = EntityDataKey.<Byte>builder(AbstractArrowDataKeys.class)
     ...
     */
    public static final EntityDataKey<Boolean> IN_GROUND = EntityDataKey.<Boolean>builder(AbstractArrowDataKeys.class)
     ...
     */
    public static final EntityDataKey<Optional<UUID>> OWNERUUID = EntityDataKey.<Optional<UUID>>builder(AbstractArrowDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Byte> PIERCE_LEVEL = EntityDataKey.<Byte>builder(AbstractArrowDataKeys.class)
