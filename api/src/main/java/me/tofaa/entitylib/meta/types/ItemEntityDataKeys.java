 ...
 */
public class ItemEntityDataKeys extends EntityDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<ItemStack> ITEM = EntityDataKey.<ItemStack>builder(ItemEntityDataKeys.class)
