...
public class ZombieMetaProperties extends MonsterMetaProperties {
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> BABY = MetadataProperty.<Boolean>builder(ZombieMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Boolean> DROWNED_CONVERSION = MetadataProperty.<Boolean>builder(ZombieMetaProperties.class)
     ...
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> SPECIAL_TYPE = MetadataProperty.<Integer>builder(ZombieMetaProperties.class)
