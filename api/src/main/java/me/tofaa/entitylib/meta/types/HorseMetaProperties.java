 ...
 */
public class HorseMetaProperties extends AbstractHorseMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Integer> TYPE_VARIANT = MetadataProperty.<Integer>builder(HorseMetaProperties.class)
