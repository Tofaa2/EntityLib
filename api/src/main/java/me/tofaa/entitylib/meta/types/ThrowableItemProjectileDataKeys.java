 ...
 */
public class ThrowableItemProjectileDataKeys extends ThrowableProjectileDataKeys {

    /**
     * Supported versions: All versions
     */
    public static final EntityDataKey<ItemStack> ITEM_STACK = EntityDataKey.<ItemStack>builder(ThrowableItemProjectileDataKeys.class)
