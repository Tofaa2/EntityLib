...
public class PrimedTntDataKeys extends EntityDataKeys {
     ...
     */
    public static final EntityDataKey<Integer> BLOCK_STATE = EntityDataKey.<Integer>builder(PrimedTntDataKeys.class)
     ...
     * Supported versions: All versions
     */
    public static final EntityDataKey<Integer> FUSE = EntityDataKey.<Integer>builder(PrimedTntDataKeys.class)
