 ...
 */
public class PrimedTntDataKeys extends EntityDataKeys {
    ...
    public static final VersionedMetadataKey<Integer> BLOCK_STATE = VersionedMetadataKey.<Integer>builder()
            .add(ClientVersion.V_1_20_3, 9, EntityDataTypes.BLOCK_STATE)
            .add(ClientVersion.V_1_20_5, 9, EntityDataTypes.BLOCK_STATE)
            .add(ClientVersion.V_1_21, 9, EntityDataTypes.BLOCK_STATE)
            .add(ClientVersion.V_1_21_2, 9, EntityDataTypes.BLOCK_STATE)
            .add(ClientVersion.V_1_21_4, 9, EntityDataTypes.BLOCK_STATE)
            .add(ClientVersion.V_1_21_5, 9, EntityDataTypes.BLOCK_STATE)
            .add(ClientVersion.V_1_21_6, 9, EntityDataTypes.BLOCK_STATE)
            .add(ClientVersion.V_1_21_9, 9, EntityDataTypes.BLOCK_STATE)
            .add(ClientVersion.V_1_21_11, 9, EntityDataTypes.BLOCK_STATE)
            .add(ClientVersion.V_26_1, 9, EntityDataTypes.BLOCK_STATE)
            .build();

    /**
     * Supported versions: All versions
     */
    public static final VersionedMetadataKey<Integer> FUSE = VersionedMetadataKey.<Integer>builder()
