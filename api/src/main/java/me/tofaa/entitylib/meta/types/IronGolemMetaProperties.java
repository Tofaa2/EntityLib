 ...
 */
public class IronGolemMetaProperties extends AbstractGolemMetaProperties {

    /**
     * Supported versions: All versions
     */
    public static final SimpleProperty<Byte> FLAGS = MetadataProperty.<Byte>builder(IronGolemMetaProperties.class)
